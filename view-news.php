...
if (isset($_GET['newsid']) && isset($_GET['news_title']) && !empty($_GET['newsid']) && !empty($_GET['news_title'])) {
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            <li><a href="#">Home</a></li>
            <li><a href="#">News</a></li>
            <li><?php echo $result['news_title']?></li>
          </ol>
        </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Project date</strong>: <?php echo $result['news_date']?></li>
            ...
            <div class="portfolio-description">
              <h2><?php echo $result['news_title']?></h2>
              <p>
                <?php echo nl2br($result['news_description'])?>
              </p>
            </div>
          </div>
