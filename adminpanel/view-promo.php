...
<head>
	<meta charset="utf-8">
	<title><?php echo $result['promo_title']?> - CheapDevs PH</title>
...
<body>
	...
	<main>
		...
		<div class="main-right">
			<h2><?php echo $result['promo_title']?></h2>

			<div class="view-box">
				<form method="post" action="action/update-promo.php" class="view-item">
					<label>
						Promo TItle<br>
						<input type="text" name="id" value="<?php echo $_GET['id']?>" hidden>
						<input type="text" name="promo_title" value="<?php echo $_GET['title']?>" hidden>
						<input type="text" name="title" class="form-control-input" required="" value="<?php echo $result['promo_title']?>">
					</label><br>
					<label>
						Promo description<br>
						<?php
							$remarks = "";
							$remarks = htmlspecialchars($result['promo_description']);
						?>
						<textarea name="description" class="form-control-input" rows="10"><?php echo $remarks?></textarea>
					</label>
					<button class="btn-update" name="update_promo">Update Content</button>
				</form>
				<form class="view-item" method="post" action="action/update-promo-image.php" enctype="multipart/form-data">
