...
<body>
	...
	<div id="modal">
    <form method="post" action="action/add-blog.php" class="view-item form-item">
      ...
      <button class="btn-update" name="post_blog">Post</button>
    </form>
  </div>
		...
		<div class="main-right">
			...
			<div class="table-div">
				<div class="table-div-flex">
					...
					?>
					<div class="table-div-flex-left"><span class="blue"><?php echo $count['COUNT(*)']?></span> total blogs</div>
					<?php
							}
						}
						else{
					?>
					<div class="table-div-flex-left"><span class="blue"></span> No blogs</div>
					<?php
						}
					?>					
					<div class="table-div-flex-right">
						<a href="#" onclick="showModal();" class="btn-add">Create Blog</a>
				...
				<table id="myTable">
					...
					<tbody>
						...
						<tr>
							...
							?>
							<td>
								<a href="view-blog?id=<?php echo $result['id']?>&title=<?php echo $result['blog_title']?>" class="btn-view">View</a>
								<a href="action/delete-blog.php?id=<?php echo $result['id']?>" class="btn-delete">Delete</a>
							</td>
						</tr>
						<?php
								}
