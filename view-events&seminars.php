    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            <li><a href="#">Home</a></li>
            <li><a href="#">Events & Seminars</a></li>
            <li><?php echo $result['es_title']?></li>
          </ol>
        </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Publish date</strong>: <?php echo $result['es_date']?></li>
            ...
            <div class="portfolio-description">
              <h2><?php echo $result['es_title']?></h2>
              <p>
                <?php echo nl2br($result['es_description'])?>
              </p>
            </div>
