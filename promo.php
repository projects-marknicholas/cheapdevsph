      ...
      <div class="container">
        <div class="pr-grid-4">
          ...
          <div class="pr-grid-item">
            <a href="new-view-promo?id=<?php echo $result['id']?>&title=<?php echo $result['promo_title']?>">
              <?php
                if ($result['image_1'] == "") {
              ...
              ?>
              <div class="pr-text">
                <h1><?php echo $result['promo_title']?></h1>
                <?php echo substr($result['promo_description'], 0, 20)?>...
              </div>
            </a>
          </div>
          <?php
