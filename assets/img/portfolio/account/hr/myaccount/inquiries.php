	...
	<main>
		...
		<div class="main-right" id="mainbar">
			<div class="page-title-box">
				<p class="page-title page-title-box">inquiries <img src="svg/notification.svg" class="svg-notification">
					<?php
				...
				<table class="attendance-table" id="table">
					<tr class="attendance-tr">
						<tbody class="attendance-tbody">
							...
							<th class="attendance-th">contact</th>
							<th class="attendance-th">email address</th>
							<th class="attendance-th">schedule date</th>
							<th class="attendance-th">remarks</th>
					...
					?>
					<tr class="attendance-tr">
						<td class="attendance-td"><?php echo $result['full_name']?></td>
						<td class="attendance-td"><?php echo $result['contact']?></td>
						<td class="attendance-td" style="text-transform: lowercase;"><?php echo $result['email_address']?></td>
						<td class="attendance-td"><?php echo $result['schedule_date']?></td>
						<td class="attendance-td"><?php echo substr($result['remarks'], 0, 20)?>...</td>
						<td class="attendance-td">
							<a href="view-inquiry.php?viewid=<?php echo $result['id']?>" class="btn-print" style="text-decoration: none;">view</a>
							<a href="action/delete-inquiry.php?viewid=<?php echo $result['id']?>" class="btn-delete" style="text-decoration: none;">delete</a>
						</td>
					</tr>
					<?php
							}
