...
<body>
	...
	<main>
		...
		<div class="main-right" id="mainbar">
			<p class="page-title">attendance</p>
			<!-- ==================== Attendance table ====================-->
				...
				<table class="attendance-table">
					<tr class="attendance-tr">
						<tbody class="attendance-tbody">
							...
							<th class="attendance-th">time in</th>
							<th class="attendance-th">time out</th>
							<th class="attendance-th">time in</th>
							<th class="attendance-th">time out</th>
					...
					<tr class="attendance-tr">
						...
						<td class="attendance-td">08:24 AM<span class="late">late</span></td>
						<td class="attendance-td">12:15 PM</td>
						<td class="attendance-td">01:25 PM<span class="not-late">on time</span></td>
						<td class="attendance-td">06:00 PM</td>
					...
					<tr class="attendance-tr">
						...
						<td class="attendance-td">0622-001</td>
						<td class="attendance-td">mark nicholas razon</td>
						<td class="attendance-td">08:24 AM<span class="not-late">On time</span></td>
						<td class="attendance-td">12:15 PM</td>
						<td class="attendance-td">01:25 PM<span class="late">late</span></td>
						<td class="attendance-td">06:00 PM</td>
						<td class="attendance-td">
							<button class="btn-edit">edit</button>
							<button class="btn-delete">delete</button>
