...
<body>
	...
	<main>
		...
		<div class="main-right" id="mainbar">
			...
			<button class="create-update-btn" onclick="showPostImage();">Post an update</button>
			<?php
					}
				}
			?><br><br>
			...
			<?php
				$sql = "SELECT * FROM posts WHERE postid = '".$_GET['viewid']."' ORDER BY id DESC";
				$res = mysqli_query($link, $sql);
			...
			<div style="width: 60%; margin: auto; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; border-radius: 7px;">
				...
				<?php 
					$image_sql = "SELECT * FROM images WHERE tracker = '".$result['tracker']."' LIMIT 1";
				...
				?>
				<div class="post-main-bx-images" onclick="window.location.href = 'view-client-post.php?viewid=<?php echo $result['id']?>&imageid=<?php echo $image_result['imageid']?>';">
