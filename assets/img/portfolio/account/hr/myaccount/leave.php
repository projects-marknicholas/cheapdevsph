				...
				<table class="attendance-table" id="table">
					<tr class="attendance-tr">
						<tbody class="attendance-tbody">
							...
							<th class="attendance-th">type</th>
							<th class="attendance-th">date started</th>
							<th class="attendance-th">date ended</th>
					...
					<tr class="attendance-tr">
						...
						<td class="attendance-td">sick leave</td>
						<td class="attendance-td">feb 11, 2022</td>
						<td class="attendance-td">feb 19, 2022</td>
