...
<head>
    ...
    <title>HR Dashboard - Unionworks Construction Company Inc.</title>
			...
			<div class="dashboard-grid">
				<div class="dashboard-item blue">
					<div class="dashboard-item-left">
						<p class="dashboard-item-count">
							<?php $res = mysqli_query($link, "SELECT COUNT(*) FROM employee");
						...
						<p class="dashboard-item-label">Total employees</p>
					</div>
					<div class="dashboard-item-right">
						<img src="../../../assets/svg/employee.svg" class="dashboard-item-svg">
					</div>
				</div>
				<div class="dashboard-item green">
					<div class="dashboard-item-left">
						<p class="dashboard-item-count">0</p>
						<p class="dashboard-item-label">Attendance for today</p>
					</div>
					<div class="dashboard-item-right">
						<img src="../../../assets/svg/attendance.svg" class="dashboard-item-svg">
					</div>
				</div>
				<div class="dashboard-item red">
					<div class="dashboard-item-left">
						<p class="dashboard-item-count">0</p>
						<p class="dashboard-item-label">Absent for today</p>
					</div>
					<div class="dashboard-item-right">
						<img src="../../../assets/svg/absent.svg" class="dashboard-item-svg">
					</div>
				</div>
			</div>
			<p class="page-title">monthly attendance report</p>
