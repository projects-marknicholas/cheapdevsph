...
<body>
	...
	<main>
		...
		<div class="main-right" id="mainbar">
			<p class="page-title">employees list</p>
			<!-- ==================== Attendance table ====================-->
				...
				<table class="attendance-table" id="table">
					<tr class="attendance-tr">
						<tbody class="attendance-tbody">
							...
							<th class="attendance-th">pin</th>
							<th class="attendance-th">photo</th>
							<th class="attendance-th">name</th>
							<th class="attendance-th">position</th>
							<th class="attendance-th">department</th>
					...
					<tr class="attendance-tr">
						...
						<td class="attendance-td">1234</td>
						<td class="attendance-td"><img src="photo.png" class="employee-photo"></td>
						<td class="attendance-td">mark nicholas razon</td>
						<td class="attendance-td">programmer</td>
						<td class="attendance-td">M10</td>
						<td class="attendance-td">08:00 AM-05:00PM</td>
						<td class="attendance-td">April 8, 2018</td>
						<td class="attendance-td">
							<button class="btn-print">print ID</button>
