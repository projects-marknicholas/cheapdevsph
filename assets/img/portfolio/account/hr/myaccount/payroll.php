		...
		<div class="main-right" id="mainbar">
			...
			<div class="attendance-div">
				<div class="table-top">
					...
					&nbsp;&nbsp;&nbsp;<button class="btn-edit">payroll</button>&nbsp;<button class="btn-print">payslip</button>&nbsp;<button class="btn-print">bulk print dtr</button>
				</div>
				<table class="attendance-table" id="table">
					...
					<tr class="attendance-tr">
						...
						<td class="attendance-td">700.00</td>
						<td class="attendance-td">350.00</td>
						<td class="attendance-td">100.00</td>
						<td class="attendance-td">340.00</td>
						<td class="attendance-td">
							<button class="btn-edit">DTR</button>
						</td>
					</tr>
					<tr class="attendance-tr">
						<td class="attendance-td">mark nicholas razon</td>
