...
if (isset($_POST['recover'])) {
    ...
    $sql = "SELECT * FROM hr WHERE username = '".$email."' ";
            ...
            function sendmail(){
                ...
                $body = "
                    ...
                    <body>
                        ...
                        <p>We recently received a request to reset your account password. Simply copy the OTP code below and we'll help you quickly and easily get back to manage your HR account.</p><br><br>
...
<head>
    ...
    <title>HR Password Recovery - Unionworks Construction Company Inc.</title>
        ...
        <div class="main-wrapper">
            ...
            <form action="" method="post" role="form">
                <div class="form-group">
                    <input type="email" name="mail" class="form-control" value="" autocomplete="off" placeholder="Email"><br>
                </div>
                <div class="form-group">
