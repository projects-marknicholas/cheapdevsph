...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        $sql = "SELECT id, username, password FROM hr WHERE username = ?";
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){           
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $_SESSION["loggedinhr"] = true;
                            $_SESSION["idhr"] = $id;
                            $_SESSION["usernamehr"] = $username; 

                            $otp = rand(000000, 999999);
                            $sql = "UPDATE hr SET code = '".$otp."' WHERE id = ".$_SESSION["idhr"]." ";
...
<head>
    ...
    <title>Employee Portal - Unionworks Construction Company Inc.</title>
...
<body>
    <main>
        ...
        <div class="main-wrapper">
            <h1>Login</h1>
            <p class="sign-description">Sign in as hr</p>
