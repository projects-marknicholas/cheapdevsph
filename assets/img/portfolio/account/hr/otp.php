<?php
	...
	if (isset($_POST['set_otp'])){
		$sql = "SELECT * FROM hr WHERE password = '".$_GET['uniqid']."' ";
...
<head>
    ...
    <title>HR Confirm OTP - Unionworks Construction Company Inc.</title>
        ...
        <div class="main-wrapper">
            ...
            <form action="" method="post" role="form">
                <div class="form-group">
                    <input type="number" name="otp" class="form-control" value="" autocomplete="off" placeholder="OTP code"><br>
                </div>
                <div class="form-group">
