...
<body>
    ...
    <main>
        ...
        <div class="main-right" id="mainbar">
            ...
            <button class="btn-sent-req" onclick="showRequest();">add leave</button>
            <form method="post" action="" class="certificate-form">
                ...
                <label>Reason of Leave<br>
                    <input type="text" name="certificate_type" value="sick leave" readonly="" class="banned-out-int">
                </label>
                <label>Remarks<br>
