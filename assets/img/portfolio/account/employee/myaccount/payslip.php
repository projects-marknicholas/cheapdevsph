...
<body>
    ...
    <main>
        ...
        <div class="main-right" id="mainbar">
            <p class="page-title">payslip</p>
            <form action="" method="post" style="font-size: .8em; float: right; margin-right: 10px;">
                <label>From
                    <input type="date" name="from" class="employee-search">
                </label>
                <label>To
                    <input type="date" name="to" class="employee-search">
                </label>
            </form>
            <br><br>
            <p class="payslip-employee-name"><strong>Employee Name: </strong>mark nicholas razon</p>
            <p class="payslip-employee-name"><strong>Employee ID: </strong>0622-001</p>
            <br><br>
            <!-- ==================== Attendance table ====================-->
                <table class="attendance-table" id="table" style="white-space: nowrap; margin: 10px;">
                    <tr class="attendance-tr">
                        <tbody class="attendance-tbody">
                            <th class="attendance-th">earnings</th>
                            <th class="attendance-th">amount</th>
                            <th class="attendance-th">deductions</th>
                            <th class="attendance-th">amount</th>
                        </tbody>
                    </tr>
                    <tr class="attendance-tr">
                        <td class="attendance-td">basic salary</td>
                        <td class="attendance-td">xxxxxxxxxx</td>
                        <td class="attendance-td">taxation</td>
                        <td class="attendance-td">xxxxxxxxxx</td>
                    </tr>
                    <tr class="attendance-tr">
                        <td class="attendance-td"></td>
                        <td class="attendance-td"></td>
                        <td class="attendance-td">UIF</td>
                        <td class="attendance-td">xxxx</td>
                    </tr>
                    <tr class="attendance-tr">
                        <td class="attendance-td"></td>
                        <td class="attendance-td"></td>
                        <td class="attendance-td">others</td>
                        <td class="attendance-td">xxxxxx</td>
                    </tr>
                    <tr class="attendance-tr">
                        <td class="attendance-td"></td>
                        <td class="attendance-td"></td>
                        <td class="attendance-td">total deductions</td>
                        <td class="attendance-td"></td>
                    </tr>
                    <tr class="attendance-tr">
                        <td class="attendance-td"></td>
                    ...
                    <tr class="attendance-tr">
                        <td class="attendance-td">gross earnings</td>
                        <td class="attendance-td">xxxxxxxxxx</td>
                        <td class="attendance-td">total deductions</td>
                        <td class="attendance-td">xxxxxxxxxx</td>
                    </tr>
                    ...
                    <tr class="attendance-tr">
                        <td class="attendance-td"></td>
                        <td class="attendance-td"></td>
                        <td class="attendance-td">net salary transferred</td>
                        <td class="attendance-td">xxxxxxxxxx</td>
                    </tr>
                </table>
