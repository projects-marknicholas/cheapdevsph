...
<body>
    ...
    <main>
        ...
        <div class="main-right" id="mainbar">
            <p class="page-title">hi <?php echo $fetch['firstname']?>! welcome to unionworks construction company inc.</p>
            <div class="employee-homepage-div">
                <p class="employee-homepage-title">We provide quality over credibility</p>
            </div>
        </div>
        <!-- ==================== Mainbar end ====================-->
    </main>
