...
if (isset($_POST['recover'])) {
    ...
    $sql = "SELECT * FROM employee WHERE username = '".$email."' ";
    ...
    if (mysqli_num_rows($query) > 0) {
        while($fetch = mysqli_fetch_assoc($query)){
            ...
            function sendmail(){
                ...
                $subject = "Employee Password Recovery";
                $body = "
                    <!DOCTYPE html>
                    <html>
                    <head>
...
<head>
    ...
    <title>Employee Password Recovery - Unionworks Construction Company Inc.</title>
