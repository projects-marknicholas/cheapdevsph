...
if(isset($_GET['uniqid'])){
        $query = mysqli_query($link, "SELECT * FROM employee WHERE `password` = '".$_GET['uniqid']."' ") or die(mysqli_error());
...
// Processing form data when form is submitted
    if(isset($_POST['create'])){
        ...
        if(empty($new_password_err) && empty($confirm_password_err)){
            ...
            $sql = "UPDATE employee SET password = '".$hashed."' WHERE id = ".$fetch['id']." ";
            ...
            if($stmt = mysqli_prepare($link, $sql)){
                ...
                $_SESSION["idemployee"] = $fetch['id'];
                $param_id = $_SESSION["idemployee"];
...
<head>
    ...
    <title>Employee Reset Password - Unionworks Construction Company Inc.</title>
