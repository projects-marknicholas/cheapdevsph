...
if(isset($_GET['uniqid'])){
        $query = mysqli_query($link, "SELECT * FROM client WHERE `password` = '".$_GET['uniqid']."' ") or die(mysqli_error());
...
// Processing form data when form is submitted
    if(isset($_POST['create'])){
        ...
        if(empty($new_password_err) && empty($confirm_password_err)){
            ...
            $sql = "UPDATE client SET password = '".$hashed."' WHERE id = ".$fetch['id']." ";
...
<head>
    ...
    <title>Client Reset Password - Unionworks Construction Company Inc.</title>
