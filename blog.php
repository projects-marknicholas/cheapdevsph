...
<head>
  ...
  <title>Blogs - CheapDevs PH</title>
      ...
      <div class="container">
        <div class="news-grid">
          <div class="news-item1">
            ...
            <?php
              $latest_sql = "SELECT * FROM blogs ORDER BY id DESC LIMIT 1";
              $latest_res = mysqli_query($link, $latest_sql);

              if (mysqli_num_rows($latest_res) > 0) {
                while ($latest_result = mysqli_fetch_assoc($latest_res)) {
            ?>
            <a href="new-view-blog?blogid=<?php echo $latest_result['id']?>&blog_title=<?php echo $latest_result['blog_title']?>" class="text-secondary">
              <div class="news-main">
                <?php
                ...
                ?>
                <h6><?php echo $latest_result['blog_title']?></h6>
                <p class="text-uppercase"><i class='bx bxs-show'></i> <?php echo $latest_result['blog_date']?>&nbsp;&nbsp;&nbsp;<span class="text-danger"><i class='bx bxs-hot'></i>
                  <?php
            ...
            <?php
              $latest_sql2 = "SELECT * FROM blogs ORDER BY id DESC LIMIT 1, 4";
            ...
            ?>
            <a href="new-view-blog?blogid=<?php echo $latest_result2['id']?>&blog_title=<?php echo $latest_result2['blog_title']?>" class="text-secondary mt-10">
              <div class="news-flexer">
                ...
                <div class="news-flexer-right">
                  <div>
                    <h6><?php echo $latest_result2['blog_title']?></h6>
                    <p class="text-uppercase"><i class='bx bxs-show'></i> <?php echo $latest_result2['blog_date']?>&nbsp;&nbsp;&nbsp;<span class="text-danger"><i class='bx bxs-hot'></i> 
                      <?php
            ...
            <?php
              $latest_sql3 = "SELECT * FROM blogs ORDER BY id LIMIT 9";
            ...
            ?>
            <a href="new-view-blog?blogid=<?php echo $latest_result3['id']?>&blog_title=<?php echo $latest_result3['blog_title']?>" class="text-secondary mt-10">
              <div class="news-flexer">
                <div class="news-flexer-right">
                  <div>
                    <h6><?php echo $latest_result3['blog_title']?></h6>
                    <p class="text-uppercase"><i class='bx bxs-show'></i> <?php echo $latest_result3['blog_date']?>&nbsp;&nbsp;&nbsp;<span class="text-danger"><i class='bx bxs-hot'></i> 
                      <?php
          ...
          <div class="news-item2">
            <?php
              $latest_sql4 = "SELECT * FROM blogs ORDER BY id DESC LIMIT 5, 1";
            ...
            ?>
            <a href="new-view-blog?blogid=<?php echo $latest_result4['id']?>&blog_title=<?php echo $latest_result4['blog_title']?>" class="text-secondary">
              <div class="news-main">
                <?php
                ...
                ?>
                <h2><?php echo $latest_result4['blog_title']?></h2>
                <p></p>
                <p class="text-uppercase"><i class='bx bxs-show'></i> <?php echo $latest_result4['blog_date']?>&nbsp;&nbsp;&nbsp;<span class="text-danger"><i class='bx bxs-hot'></i> 
                  <?php
            ...
            <div class="news-item-flex-main">
              <?php
                $latest_sql5 = "SELECT * FROM blogs ORDER BY id DESC LIMIT 6, 4";
              ...
              <div class="news-item-flex-main-item">
                <a href="new-view-blog?blogid=<?php echo $latest_result5['id']?>&blog_title=<?php echo $latest_result5['blog_title']?>" class="text-secondary">
                  <div class="news-main">
                    <?php
                    ...
                    ?>
                    <h6><?php echo $latest_result5['blog_title']?></h6>
                    <p class="text-uppercase"><i class='bx bxs-show'></i> <?php echo $latest_result5['blog_date']?>&nbsp;&nbsp;&nbsp;<span class="text-danger"><i class='bx bxs-hot'></i> 
                      <?php
          ...
          <div class="news-item3">
            ...
            <?php
              $latest_sql6 = "SELECT * FROM blogs ORDER BY id DESC LIMIT 11, 6";
            ...
            ?>
            <a href="new-view-blog?blogid=<?php echo $latest_result6['id']?>&blog_title=<?php echo $latest_result6['blog_title']?>" class="text-secondary mt-10">
              <div class="news-flexer">
                <div class="news-flexer-left">
                  <?php
                ...
                <div class="news-flexer-right">
                  <div>
                    <h6><?php echo $latest_result6['blog_title']?></h6>
                    <p class="text-uppercase"><i class='bx bxs-show'></i> <?php echo $latest_result6['blog_date']?>&nbsp;&nbsp;&nbsp;<span class="text-danger"><i class='bx bxs-hot'></i> 
                    <?php
            ...
            <?php
              $latest_sql7 = "SELECT * FROM blogs ORDER BY rand() DESC LIMIT 9";
            ...
            ?>
            <a href="new-view-blog?blogid=<?php echo $latest_result7['id']?>&blog_title=<?php echo $latest_result7['blog_title']?>" class="text-secondary mt-10">
              <div class="news-flexer">
                <div class="news-flexer-right">
                  <div>
                    <h6><?php echo $latest_result7['blog_title']?></h6>
                    <p class="text-uppercase"><i class='bx bxs-show'></i> <?php echo $latest_result7['blog_date']?>&nbsp;&nbsp;&nbsp;<span class="text-danger"><i class='bx bxs-hot'></i> 
                      <?php
